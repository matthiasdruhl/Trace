...
| `sql_filter` | `string` | no | Optional metadata filter string; max **8192 Unicode scalar values** (character count). Currently accepted and validated; not yet applied to the Lance scan. |
